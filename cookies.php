...
$q1 = mysqli_query($conn, "SELECT * FROM cookies");
...
$sql = "SELECT * FROM cookies LIMIT ".$p.", ".$rowsperpage;
...
echo '<button class="fancy-button medium rounded carrot-back" style="cursor:pointer;" onclick="LoadDatacookies('.$prev_page.')"> <i class="fas fa-arrow-left"></i> Back<span ></span></button>';
...
echo '<button class="fancy-button medium rounded carrot horizontal"  onclick="LoadDatacookies('.$next_page.')" style="cursor:pointer";>  Next<span 
