...
$q1 = mysqli_query($conn, "SELECT * FROM bread");
...
$sql = "SELECT * FROM bread LIMIT ".$p.", ".$rowsperpage;
...
echo '<button class="fancy-button medium rounded carrot-back" style="cursor:pointer;" onclick="LoadDatab('.$prev_page.')"> <i class="fas fa-arrow-left"></i> Back<span ></span></button>';
...
echo '<button class="fancy-button medium rounded carrot horizontal"  onclick="LoadDatab('.$next_page.')" style="cursor:pointer";>  Next<span 
