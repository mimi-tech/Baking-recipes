...
$q1 = mysqli_query($conn, "SELECT * FROM cupcake");
...
$sql = "SELECT * FROM cupcake LIMIT ".$p.", ".$rowsperpage;
...
echo '<button class="fancy-button medium rounded carrot-back" style="cursor:pointer;" onclick="LoadDatacc('.$prev_page.')"> <i class="fas fa-arrow-left"></i> Back<span ></span></button>';
...
echo '<button class="fancy-button medium rounded carrot horizontal"  onclick="LoadDatacc('.$next_page.')" style="cursor:pointer";>  Next<span 
