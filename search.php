...
if(isset($_GET['details_cupcake'])){
    $id = ($_GET['details_cupcake']);
   
}else{
    $id = '';
}

$sql = "SELECT * FROM cupcake WHERE id = '$id'";
    $run_query = mysqli_query($conn,$sql);
    $count = mysqli_num_rows($run_query);
    if($count > 0){
...
if(isset($_GET['details_cheese'])){
    $id = ($_GET['details_cheese']);
   
}else{
    $id = '';
}

$sql = "SELECT * FROM cheese WHERE id = '$id'";
    $run_query = mysqli_query($conn,$sql);
    $count = mysqli_num_rows($run_query);
    if($count > 0){
...
if(isset($_GET['details_pies'])){
    $id = ($_GET['details_pies']);
...
if(isset($_GET['details_cookies'])){
    $id = ($_GET['details_cookies']);
...
if(isset($_GET['details_bread'])){
    $id = ($_GET['details_bread']);
...
if(isset($_GET['details_dough'])){
    $id = ($_GET['details_dough']);
   
}else{
    $id = '';
}

$sql = "SELECT * FROM dough WHERE id = '$id'";
    $run_query = mysqli_query($conn,$sql);
    $count = mysqli_num_rows($run_query);
    if($count > 0){
...
if(isset($_GET['details_dessert'])){
    $id = ($_GET['details_dessert']);
...
if(isset($_GET['details_french'])){
    $id = ($_GET['details_french']);
   
}else{
    $id = '';
}

$sql = "SELECT * FROM french_desert WHERE id = '$id'";
    $run_query = mysqli_query($conn,$sql);
    $count = mysqli_num_rows($run_query);
    if($count > 0){
...
if(isset($_GET['details_pudding'])){
    $id = ($_GET['details_pudding']);
   
}else{
    $id = '';
}

$sql = "SELECT * FROM pudding WHERE id = '$id'";
    $run_query = mysqli_query($conn,$sql);
    $count = mysqli_num_rows($run_query);
    if($count > 0){
