...
$q1 = mysqli_query($conn, "SELECT * FROM cheese");
...
$sql = "SELECT * FROM cheese LIMIT ".$p.", ".$rowsperpage;
...
echo '<button class="fancy-button medium rounded carrot-back" style="cursor:pointer;" onclick="LoadDatach('.$prev_page.')"> <i class="fas fa-arrow-left"></i> Back<span ></span></button>';
...
echo '<button class="fancy-button medium rounded carrot horizontal"  onclick="LoadDatach('.$next_page.')" style="cursor:pointer";>  Next<span 
