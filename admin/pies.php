...
if(isset($_POST['add'])){ 
   ...
   $frosting = mysqli_real_escape_string($conn, $_POST['frosting']);
	...
	$file = mysqli_real_escape_string($conn, $_POST['file']);
	 ...
	 $insertsql = "INSERT INTO `yummy`.`pies` ( `title`, `duration`, `ingredient`, `frosting`, `direction`, `nutrition`,  `serving`) VALUES ('$title', '$duration', '$ingredient', '$frosting', '$direction', '$nutrition', '$serving')";
...
if(isset($_GET['featured'])){
    ...
    $featuredsql = "UPDATE pies SET featured = '$featured' WHERE id = '$id'";
...
<div class="col-sm-8">
	<h1 class="yellow">Pie &amp; Tarts Products</h1> 
...
<table class="container" id="dataTables-example">
    ...
    <tbody>
        ...
        <tr>
        <td>
        <a href="editpies.php?edit=<?php echo $product['id']; ?>" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-pencil"></span></a>
         <a class="delete_pie btn btn-xs btn-default" data-emp-id="<?php echo $product['id']; ?>" href="javascript:void(0)">
 ...
 <div class="row">
 	<div class="col-sm-2"></div>
 	<div class="col-sm-8 ">
  <form action="pies" method="post" enctype="multipart/form-data" id="pro-form" style="display:none;" autocomplete="off" class="prod-form">
     <h1>Add pies product</h1>
