...
<?php
    ...
    $edit_id = ($_GET['edit']);
        $sql = ("SELECT * FROM french_desert WHERE id = '$edit_id'");
   ...
   $frosting = mysqli_real_escape_string($conn, $_POST['frosting']);
	...
	$file = mysqli_real_escape_string($conn, $_POST['file']);
		...
		$edit_query = "UPDATE french_desert SET title = '$title', duration = '$duration', ingredient = '$ingredient', frosting = '$frosting', direction = '$direction', nutrition = '$nutrition', serving = '$serving' WHERE id = '$edit_id'";
		 $result = mysqli_query($conn,$edit_query);
		if($result){
		header("Location:editfrench.php");
		}
  ...
  <form action="editfrench?<?php echo ((isset($_GET['edit']))?'edit='.$edit_id:'add=1'); ?>" method="post" enctype="multipart/form-data" class="edit-form">
      <div class="form-group col-sm-4">
        ...
        <div class="form-group col-sm-4">
            ...
            <div class="form-group col-sm-3">
            <a href="editfrench.php" class="btn btn-danger" role="button">Cancel</a>
