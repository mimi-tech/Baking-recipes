...
<?php
    ...
    $edit_id = ($_GET['edit']);
        $sql = ("SELECT * FROM desserts WHERE id = '$edit_id'");
   ...
   $frosting = mysqli_real_escape_string($conn, $_POST['frosting']);
	...
	$file = mysqli_real_escape_string($conn, $_POST['file']);
		...
		$edit_query = "UPDATE desserts SET title = '$title', duration = '$duration', ingredient = '$ingredient', frosting = '$frosting', direction = '$direction', nutrition = '$nutrition', serving = '$serving' WHERE id = '$edit_id'";
  ...
  <form action="editdessert?<?php echo ((isset($_GET['edit']))?'edit='.$edit_id:'add=1'); ?>" method="post" enctype="multipart/form-data" class="edit-form">
        ...
        <div class="form-group col-sm-3">
            ...
            <div class="form-group col-sm-3">
             ...
             <div class="form-group col-sm-3">
               ...
               <div class="saved-image col-sm-4"><img src="/mimikfoods/imagesdessert/<?php echo $saved_image; ?> " alt="saved image" class="img-responsive"><br/>
               <a href="editdessertimage.php?id=<?php echo $edit_id; ?>" class="text-danger" onclick="return true;">Delete</a>
               </div>
