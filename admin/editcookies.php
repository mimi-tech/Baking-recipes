...
<?php
    ...
    $edit_id = ($_GET['edit']);
        $sql = ("SELECT * FROM cookies WHERE id = '$edit_id'");
   ...
   $frosting = mysqli_real_escape_string($conn, $_POST['frosting']);
	...
	$file = mysqli_real_escape_string($conn, $_POST['file']);
		...
		$edit_query = "UPDATE cookies SET title = '$title', duration = '$duration', ingredient = '$ingredient', frosting = '$frosting', direction = '$direction', nutrition = '$nutrition', serving = '$serving' WHERE id = '$edit_id'";
