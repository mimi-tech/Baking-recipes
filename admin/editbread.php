...
<?php
    ...
    $edit_id = ($_GET['edit']);
        $sql = ("SELECT * FROM bread WHERE id = '$edit_id'");
   ...
   $frosting = mysqli_real_escape_string($conn, $_POST['frosting']);
	...
	$file = mysqli_real_escape_string($conn, $_POST['file']);
		...
		$edit_query = "UPDATE bread SET title = '$title', duration = '$duration', ingredient = '$ingredient', frosting = '$frosting', direction = '$direction', nutrition = '$nutrition', serving = '$serving' WHERE id = '$edit_id'";
 ...
 <style>
  ...
  <form action="editbread?<?php echo ((isset($_GET['edit']))?'edit='.$edit_id:'add=1'); ?>" method="post" enctype="multipart/form-data" class="edit-form">
