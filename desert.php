...
$q1 = mysqli_query($conn, "SELECT * FROM desserts");
...
$sql = "SELECT * FROM desserts LIMIT ".$p.", ".$rowsperpage;
...
<div class="single-menu-list row justify-content-between align-items-center">
								<div class="col-lg-12 flex-row d-flex">
...
echo '<button class="fancy-button medium rounded carrot-back" style="cursor:pointer;" onclick="LoadDatad('.$prev_page.')"> <i class="fas fa-arrow-left"></i> Back<span ></span></button>';
...
echo '<button class="fancy-button medium rounded carrot horizontal"  onclick="LoadDatad('.$next_page.')" style="cursor:pointer";>  Next<span 
