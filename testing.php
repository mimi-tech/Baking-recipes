...
$q1 = mysqli_query($conn, "SELECT * FROM cake");
...
$sql = "SELECT * FROM cake LIMIT ".$p.", ".$rowsperpage;
...
echo '<button class="fancy-button medium rounded carrot-back" style="cursor:pointer;" onclick="LoadData('.$prev_page.')"> <i class="fas fa-arrow-left"></i> Back<span ></span></button>';
...
echo '<button class="fancy-button medium rounded carrot horizontal"  onclick="LoadData('.$next_page.')" style="cursor:pointer";>  Next<span 
