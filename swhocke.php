...
$sql = "SELECT * FROM cake WHERE id = 35";
...
$sqls = "SELECT * FROM cupcake WHERE id = 3";
$result_querys = mysqli_query($conn,$sqls);
while($row = mysqli_fetch_assoc($result_querys)){
	
	
	                $titles = mysqli_real_escape_string($conn,$row['title']);
	                $durations = mysqli_real_escape_string($conn,$row['duration']);
	                $servings = mysqli_real_escape_string($conn,$row['serving']);
	                $ingredients = mysqli_real_escape_string($conn,$row['ingredient']);
					$directions = mysqli_real_escape_string($conn,$row['direction']);
					$nutritions = mysqli_real_escape_string($conn,$row['nutrition']);
					
					$ingredients = htmlentities($row['ingredient'], ENT_QUOTES, "UTF-8");
					$directions = htmlentities($row['direction'], ENT_QUOTES, "UTF-8");
					$nutritions = htmlentities($row['nutrition'], ENT_QUOTES, "UTF-8");
					
					$ingredients = str_replace("\r\n","<li>", $ingredients);
					$directions = str_replace("\r\n","<br />", $directions);
					$nutritions = str_replace("\r\n","<li>", $nutritions);
			  ...
			  <p><br /></p>
			 	...
			 	<div class="col-sm-2"></div>
			 			...
			 			<div class="col-sm-3">
			 				...
			 				<img src="img/diyimages/madeiracake_new.jpg" class="img-fluid">
			...
			<section>
				<div class="row">
			 	<div class="col-sm-2"></div>
			 			...
			 			<div class="col-sm-3">
			 				<h4><?php echo $titles;?></h4><br/>
			 				<img src="img/diyimages/bakingpix/citrus-coconut-muffins.jpg" width="100%"><br />
			 				<p><?php echo $servings;?></p>
			 				<p><?php echo $durations;?></p> <br />
			 				<h4>Nutrition</h4>
			 				<p><?php echo $nutritions;?></p>
			 			</div>
