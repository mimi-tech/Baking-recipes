...
$q1 = mysqli_query($conn, "SELECT * FROM pudding");
...
$sql = "SELECT * FROM pudding LIMIT ".$p.", ".$rowsperpage;
...
echo '<button class="fancy-button medium rounded carrot-back" style="cursor:pointer;" onclick="LoadDatapu('.$prev_page.')"> <i class="fas fa-arrow-left"></i> Back<span ></span></button>';
...
echo '<button class="fancy-button medium rounded carrot horizontal"  onclick="LoadDatapu('.$next_page.')" style="cursor:pointer";>  Next<span 
