...
$q1 = mysqli_query($conn, "SELECT * FROM basic");
...
$sql = "SELECT * FROM basic LIMIT ".$p.", ".$rowsperpage;
...
echo '<button class="fancy-button medium rounded carrot-back" style="cursor:pointer;" onclick="LoadDataba('.$prev_page.')"> <i class="fas fa-arrow-left"></i> Back<span ></span></button>';
...
echo '<button class="fancy-button medium rounded carrot horizontal"  onclick="LoadDataba('.$next_page.')" style="cursor:pointer";>  Next<span 
