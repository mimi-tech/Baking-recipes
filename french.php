...
$q1 = mysqli_query($conn, "SELECT * FROM french_desert");
...
$sql = "SELECT * FROM french_desert LIMIT ".$p.", ".$rowsperpage;
...
<div class="single-menu-list row justify-content-between align-items-center">
								<div class="col-sm-12 row d-flex">
...
echo '<button class="fancy-button medium rounded carrot-back" style="cursor:pointer;" onclick="LoadDatafrench('.$prev_page.')"> <i class="fas fa-arrow-left"></i> Back<span ></span></button>';
...
echo '<button class="fancy-button medium rounded carrot horizontal"  onclick="LoadDatafrench('.$next_page.')" style="cursor:pointer";>  Next<span 
