...
$q1 = mysqli_query($conn, "SELECT * FROM dough");
...
echo '<button class="fancy-button medium rounded carrot-back" style="cursor:pointer;" onclick="LoadDatado('.$prev_page.')"> <i class="fas fa-arrow-left"></i> Back<span ></span></button>';
...
echo '<button class="fancy-button medium rounded carrot horizontal"  onclick="LoadDatado('.$next_page.')" style="cursor:pointer";>  Next<span 
